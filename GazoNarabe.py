...
class GazoNarabeApplication(ttk.Frame):
    ...
    def commandResetSettings(self):
        ...
        self.page_title.set(self.page_title_default)
        self.page_title_align.set(self.page_title_align_default)
        self.page_size.set(self.page_size_default)
        self.image_title.set(self.image_title_default)
        self.image_width.set(self.image_width_default)
        self.image_height.set(self.image_height_default)
        self.cell_height.set(self.cell_height_default)
        self.font_name.set(self.font_name_default)
        self.font_size.set(self.font_size_default)
